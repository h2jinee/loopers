...
public class OrderTest {
    ...
    class Create {
        ...
        void createOrder_withValidInfo() {
            ...
            // act
            Order order = new Order(userId, receiverInfo);
        ...
        void initialStatus_isPaymentPending() {
            // act
            Order order = new Order("testUser", receiverInfo);
    ...
    /*
     * 결제 시간 만료 확인 단위 테스트
     * - [x] PENDING 상태에서 결제 시간이 만료되지 않았으면 false를 반환한다.
     * - [x] PENDING 상태에서 결제 시간이 만료되었으면 true를 반환한다.
     * - [x] PENDING이 아닌 상태에서는 항상 false를 반환한다.
     */
    ...
    class PaymentExpiration {
        ...
        void setUp() {
            ...
            order = new Order("testUser", receiverInfo);
        }

        @DisplayName("PENDING 상태에서 결제 시간이 만료되지 않았으면 false를 반환한다.")
        @Test
        ...
        @DisplayName("PENDING이 아닌 상태에서는 항상 false를 반환한다.")
        @Test
    ...
    /*
     * 결제 확정/실패 단위 테스트
     * - [x] PENDING 상태에서 결제를 확정할 수 있다.
     * - [x] PENDING이 아닌 상태에서 결제 확정 시 BAD_REQUEST를 반환한다.
     * - [x] PENDING이 아닌 상태에서 결제 실패 처리 시 BAD_REQUEST를 반환한다.
     */
    ...
    class PaymentProcessing {
        ...
        @DisplayName("PENDING 상태에서 결제를 확정할 수 있다.")
        @Test
        ...
        @DisplayName("PENDING이 아닌 상태에서 결제 확정 시 BAD_REQUEST를 반환한다.")
        @Test
        ...
        @DisplayName("PENDING이 아닌 상태에서 결제 실패 처리 시 BAD_REQUEST를 반환한다.")
        @Test
